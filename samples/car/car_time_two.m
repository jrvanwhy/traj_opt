...
% at position 1, then after a second period it must be back at position 0.
% Total time should be minimized without exceeding the minimum and maximum force limitations.
%
...
function scenario = car_time_two(n_intervals) % Added phase output for debugging, should remove once done.
	...
	phase1 = traj_setup_dynamic_phase('transit1',               ...
	                                  @dynamic_system,          ...
	                                  {'position', 'velocity'}, ...
	                                  {'force'},                ...
	                                  n_intervals);
	phase2 = traj_setup_dynamic_phase('transit2',               ...
	                                  @dynamic_system,          ...
	                                  {'position', 'velocity'}, ...
	                                  {'force'},                ...
	                                  n_intervals);
