...
%     params      The parameters for this phase -- a cell column vector of strings.
%     struct_type      The type of this struct -- always 'phase'
...
function phase = gen_dynsys_fcns(phase, dynsys_fcn)
	...
	phases.dynsys.dx = matlabFunction(simplify(dynsys_dx), 'vars', {sym_state, sym_input, sym_add_params, sym_noopt_params});
